var article=document.getElementsByClassName("page-content")[0];var markdown_body=document.createElement("div");markdown_body.setAttribute("class","markdown-body")
var card_columns=document.createElement("div");card_columns.setAttribute("class","card-columns")
for(const each of gallery||[]){var card=document.createElement("div");card.setAttribute("class","card");var card_a=document.createElement("a");card_a.setAttribute("data-fancybox","images")
...
var card_img=document.createElement("img");card_img.setAttribute("class","card-img-top")
